  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'field-pattern': 'linear-gradient(135deg, #f0fdf4 25%, transparent 25%), linear-gradient(225deg, #f0fdf4 25%, transparent 25%), linear-gradient(45deg, #f0fdf4 25%, transparent 25%), linear-gradient(315deg, #f0fdf4 25%, #fefce8 25%)',
      },
      animation: {
